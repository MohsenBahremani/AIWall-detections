...
|---|---|---|---|---|---|---|
| Secret leak blocked | 107210 | `aiwall_secret_leak_blocked` | `aiwall_secret_leak_blocked` | [AML.T0057](https://atlas.mitre.org/) LLM Data Leakage | AML.T0055 Unsecured Credentials | LLM02 |
| Content policy block | 107211 | `aiwall_policy_block` | `aiwall_policy_block` | [AML.T0048](https://atlas.mitre.org/) External Harms | — | LLM05 |
| Cost threshold block | 107212 | `aiwall_cost_threshold` | `aiwall_cost_threshold` | [AML.T0034](https://atlas.mitre.org/) Cost Harvesting | — | LLM10 |
| Cost budget block | 107216 | — | `aiwall_cost_threshold` | [AML.T0034](https://atlas.mitre.org/) Cost Harvesting | — | LLM10 |
